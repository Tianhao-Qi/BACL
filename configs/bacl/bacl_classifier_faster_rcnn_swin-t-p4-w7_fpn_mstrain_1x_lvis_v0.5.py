_base_ = './faster_rcnn_swin-t-p4-w7_fpn_mstrain_1x_lvis_v0.5.py'
...
load_from = './work_dirs/bacl_representation_faster_rcnn_swin-t-p4-w7_fpn_1x_lvis_v0.5/epoch_12.pth'
