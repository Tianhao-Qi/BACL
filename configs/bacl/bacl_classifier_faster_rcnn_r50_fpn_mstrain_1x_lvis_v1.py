_base_ = './faster_rcnn_r50_fpn_mstrain_1x_lvis_v1.py'
...
model = dict(
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='FCBL', use_sigmoid=True, loss_weight=1.0, num_classes=1203, alpha=0.85, prob_thr=0.7),
...
load_from = './work_dirs/bacl_representation_faster_rcnn_r50_fpn_1x_lvis_v1/epoch_12.pth'
